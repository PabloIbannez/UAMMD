/*Raul P. Pelaez 2018. Inertial Coupling Method for particles in an incompressible fluctuating fluid.
...
namespace uammd{
  namespace Hydro{
	...
	bool sumThermalDrift = true;
      ...
      using cufftComplex3 = ICM_ns::cufftComplex3;
    ...
    private:
      ...
      thrust::device_vector<cufftComplex> gridVelsPrediction; 
